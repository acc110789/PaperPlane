...
class GuokrHandpickContentRemoteDataSource internal constructor(private val mGuokrHandpickService: GuokrHandpickService) {

    suspend fun getGuokrHandpickContent(id: Int): Result<GuokrHandpickContentResult> = withContext(Dispatchers.IO) {
        try {
