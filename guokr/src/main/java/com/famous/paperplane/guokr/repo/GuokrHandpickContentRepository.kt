...
import com.famous.paperplane.guokr.GuokrHandpickContentDataSource
...
class GuokrHandpickContentRepository internal constructor(
    private val mRemoteDataSource: GuokrHandpickContentRemoteDataSource,
    private val mLocalDataSource: GuokrHandpickContentLocalDataSource
) {
